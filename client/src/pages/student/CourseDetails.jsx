...
const CourseDetails = () => {
  ...
  return courseData ?(
    <>
      ...
      justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className="md:text-course-deatails-heading-large text-course-deatails-heading-small
       font-semibold text-gray-800">
          ...
          {/* review and ratings */}
                ...
                <p className='text-sm'>Course by <span className='text-blue-600 underline'>Lalit-LMS</span></p>
